...
export const AboutPage = () => {
    return (
        <main className="page-fullscreen">
            ...
            <hr />
            <p>If our project has helped you, consider <Link to="https://ko-fi.com/ivyrze" target="_blank" rel="noopener" className="link--regular">supporting us on Ko-fi</Link>. We don't make money by running ads or selling user data, so your contributions are what help keep the (server) lights on.</p>
        </main>
    );
};
