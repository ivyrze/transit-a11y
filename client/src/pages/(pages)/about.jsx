...
export const AboutPage = () => {
    return (
        <main className="page-fullscreen">
            ...
            <p>These barriers push disabled people to their physical and financial limits, stripping away their well-being. The American Association for People with Disabilities estimates that over 3 million disabled people never leave the home because of <Link href="https://www.aapd.com/transportation/" target="_blank" rel="noreferrer" className="link-regular">transportation difficulties</Link>.</p>
            ...
            <hr />
            <p>If our project has helped you, consider <Link href="https://ko-fi.com/ivyrze" target="_blank" rel="noopener" className="link-regular">supporting us on Ko-fi</Link>. We don't make money by running ads or selling user data, so your contributions are what help keep the (server) lights on.</p>
        </main>
    );
};
